package de.strafbefehl.deluxehubreloaded.command;
...
import de.strafbefehl.deluxehubreloaded.command.commands.*;
import de.strafbefehl.deluxehubreloaded.command.commands.gamemode.*;
...
public class CommandManager {
    ...
    public CommandManager(DeluxeHubReloadedPlugin plugin) {
        this.plugin = plugin;

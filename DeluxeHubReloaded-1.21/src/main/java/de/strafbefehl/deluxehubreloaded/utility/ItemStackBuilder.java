package de.strafbefehl.deluxehubreloaded.utility;
...
import de.strafbefehl.deluxehubreloaded.hook.hooks.head.HeadHook;
...
public class ItemStackBuilder {
    ...
    private static final DeluxeHubReloadedPlugin PLUGIN = JavaPlugin.getPlugin(DeluxeHubReloadedPlugin.class);

package de.strafbefehl.deluxehubreloaded.inventory.inventories;

import de.strafbefehl.deluxehubreloaded.inventory.InventoryItem;
...
import de.strafbefehl.deluxehubreloaded.inventory.InventoryBuilder;
...
public class CustomGUI extends AbstractInventory {
    ...
    public CustomGUI(DeluxeHubReloadedPlugin plugin, FileConfiguration config) {
        super(plugin);
        this.config = config;
    }
